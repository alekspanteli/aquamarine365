  ...
  return (
    <>
      ...
      <p className="text-lg mt-4">
        ...
        your booking and run your stay. We don&apos;t sell data, we don&apos;t run retargeting ads, and
      ...
      <p>
        We don&apos;t add you to a newsletter without asking, and we don&apos;t share your contact
      ...
      <p>
        We don&apos;t use ad networks or analytics. If that ever changes, we&apos;ll update this page
      ...
      <ul>
        ...
        <li><strong>Enquiries that didn&apos;t convert</strong> — 12 months, then deleted</li>
      ...
      <ul>
        ...
        <li>Ask us to delete what&apos;s not legally required (post-retention deletion is automatic anyway)</li>
