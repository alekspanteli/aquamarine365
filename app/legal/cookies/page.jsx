  ...
  return (
    <>
      ...
      <p className="text-lg mt-4">
        Short version: we don&apos;t use analytics, tracking pixels, or marketing cookies. Everything
      ...
      <p>
        ...
        page doesn&apos;t lose it. Never sent anywhere; purely local.
      </p>
      ...
      <p>
        ...
        domains when you interact with them — we don&apos;t see or control those cookies:
      </p>
      <ul>
        <li>
      ...
      <p>
        We don&apos;t embed YouTube, Vimeo, Facebook widgets, or third-party chat tools. The chat on
